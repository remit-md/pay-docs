...
2. If `settlement == "tab"`: finds or opens a tab, charges it, retries with payment headers
3. If `settlement == "direct"`: calls `pay_direct()`, retries with `X-Payment-Tx` header
